    ...
    constructor() {
        this.products = [
            ...
            },
            {
                ...
                model: 'FLAG-HUB-FIBERGLASS-POLE',
                sku: 'FLG-HUB-FGP',
                name: '沙滩旗杆（玻纤杆）',
                nameEn: 'Beach Flag Poles (Fiberglass Pole)',
                nameZh: '沙滩旗杆（玻纤杆）',
                shortEn: 'Modular fiberglass beach flag poles — variant rows from the flag type page.',
            ...
            },
            {
                ...
                model: 'FLAG-HUB-ALU-FIBERGLASS',
                sku: 'FLG-HUB-AFG',
                name: '沙滩旗杆（铝管 + 玻纤）',
                nameEn: 'Beach Flag Poles (Aluminium + Fiberglass)',
                nameZh: '沙滩旗杆（铝管 + 玻纤）',
                shortEn: 'Hybrid aluminium + fiberglass pole sets — versions and rows on the flag type page.',
            ...
            },
            {
                ...
                model: 'FLAG-HUB-FG-TEARDROP',
                sku: 'FLG-HUB-FGT',
                name: '水滴型沙滩旗杆（全玻纤）',
                nameEn: 'Teardrop Beach Flag Poles (Fully Fiberglass)',
                nameZh: '水滴型沙滩旗杆（全玻纤）',
                shortEn: 'Fully fiberglass teardrop pole sets (AD-D1 … AD-D3).',
            ...
            },
            {
                ...
                model: 'FLAG-HUB-FG-FEATHER',
                sku: 'FLG-HUB-FGF',
                name: '刀型沙滩旗杆（全玻纤）',
                nameEn: 'Feather Beach Flag Poles (Fully Fiberglass)',
                nameZh: '刀型沙滩旗杆（全玻纤）',
                shortEn: 'Fully fiberglass feather pole sets (AD-A1 … AD-A3).',
            ...
            },
            {
                ...
                model: 'FLAG-HUB-OUTDOOR-GIANT',
                sku: 'FLG-HUB-OGW',
                name: '户外注水旗杆（Giant Flag）',
                nameEn: 'Outdoor Giant Flag (Water Base)',
                nameZh: '户外注水旗杆（Giant Flag）',
                shortEn: 'Telescopic giant flag poles with water base (AD-11Z01 …).',
            ...
            },
            {
                ...
                model: 'FLAG-HUB-SQUARE-FG',
                sku: 'FLG-HUB-SQF',
                name: '方型沙滩旗杆（玻纤）',
                nameEn: 'Square Flag Pole (Fiberglass)',
                nameZh: '方型沙滩旗杆（玻纤）',
                shortEn: 'Square fiberglass flag poles (AD-F10A … AD-F10C).',
            ...
            },
            {
                ...
                model: 'FLAG-HUB-ALU-SEMICIRCLE',
                sku: 'FLG-HUB-ALU-SC',
                name: '铝合金沙滩旗杆（半圆）',
                nameEn: 'Aluminium Beach Flag Pole — Semicircle',
                nameZh: '铝合金沙滩旗杆（半圆）',
                shortEn: 'American-style semicircle aluminium beach flag poles (WK-36A …).',
            ...
            },
            {
                ...
                model: 'FLAG-HUB-ALU-SQUARE',
                sku: 'FLG-HUB-ALU-SQ',
                name: '铝合金沙滩旗杆（方型）',
                nameEn: 'Aluminium Beach Flag Pole — Square',
                nameZh: '铝合金沙滩旗杆（方型）',
                shortEn: 'American-style square aluminium beach flag poles (WK-33A …).',
            ...
            },
            {
                ...
                model: 'FLAG-HUB-ALU-NEW-FEATHER',
                sku: 'FLG-HUB-ALU-NF',
                name: '铝合金沙滩旗杆（新型刀旗）',
                nameEn: 'Aluminium Beach Flag Pole — New Feather',
                nameZh: '铝合金沙滩旗杆（新型刀旗）',
                shortEn: 'New feather aluminium poles (AD-42A … AD-42C).',
            ...
            },
            {
                ...
                model: 'FLAG-HUB-ALU-FEATHER-TEAR',
                sku: 'FLG-HUB-ALU-FT',
                name: '铝合金沙滩旗杆（刀旗/水滴）',
                nameEn: 'Aluminium Beach Flag Pole — Feather/Teardrop',
                nameZh: '铝合金沙滩旗杆（刀旗/水滴）',
                shortEn: 'American aluminium poles for feather/teardrop flags (AD-39A …).',
            ...
            },
            {
                ...
                model: 'FLAG-HUB-BASES-ACC',
                sku: 'FLG-HUB-BASE-ACC',
                name: '沙滩旗底座与配件',
                nameEn: 'Beach Flag Bases & Accessories',
                nameZh: '沙滩旗底座与配件',
                shortEn: 'Bases, spikes, rotors and bags for beach flags — rows on the accessories type page.',
            ...
            // 24 accessories items mapped to the overview sprite (IDs 9001-9024). Names + descriptions align with tent-types.js specTable; listed under all-products (all categories).
            {
                id: 9001,
            ...
            },
            {
                ...
                category: 'accessories',
                model: 'WK-T15',
                name: '30/40方型帐篷架连接件 (WK-T15)',
                nameZh: '30/40方型帐篷架连接件',
            ...
            },
            {
                ...
                category: 'accessories',
                model: 'WK-T16',
                name: '40/50菱形帐篷架连接件 (WK-T16)',
                nameZh: '40/50菱形帐篷架连接件',
            ...
            // ===== Furniture series: Table / Chair / Stool / Toilet (hero/image pending) =====
            {
                ...
                model: 'WK-Z122 / WK-Z153 / WK-Z183 / WK-Z244',
                name: '对折桌（多尺寸）',
                nameEn: 'Folding In Half Tables (Multiple Sizes)',
                nameZh: '对折桌（多尺寸）',
            ...
            },
            {
                ...
                category: 'furniture',
                subcategory: 'table-chair-stool-toilet',
                model: 'WK-YZ120 / WK-YZ150 / WK-YZ180',
                name: '圆形对折桌（多尺寸）',
                nameEn: 'Round Folding In Half Tables (Multiple Sizes)',
                nameZh: '圆形对折桌（多尺寸）',
                description: '同一系列圆形对折桌，多种直径尺寸可选；可选型号：WK-YZ120、WK-YZ150、WK-YZ180。圆形台面、对折收纳，适用于活动与户外。',
                descriptionEn: 'One series of round folding-in-half tables in multiple diameters. Models: WK-YZ120, WK-YZ150, and WK-YZ180. Round top, folds in half—ideal for events and outdoor use.',
                descriptionZh: '同一系列圆形对折桌，多种直径尺寸可选；可选型号：WK-YZ120、WK-YZ150、WK-YZ180。圆形台面、对折收纳，适用于活动与户外。',
                image: '',
                specs: ['可选型号：WK-YZ120、WK-YZ150、WK-YZ180', '圆形台面', '对折收纳', '便携'],
                specsEn: ['Models: WK-YZ120, WK-YZ150, WK-YZ180', 'Round top', 'Folds in half', 'Portable'],
                keywords: ['furniture', 'table', 'round table', 'folding table', '圆形对折桌', 'WK-YZ120', 'WK-YZ150', 'WK-YZ180']
            },
            {
                id: 31013,
                category: 'furniture',
            ...
            // ===== Bi-fold table tablecloths — under 桌/椅/凳/厕所; images: images/products/custom/table-covers/ =====
            {
                id: 31101,
                category: 'furniture',
                subcategory: 'table-chair-stool-toilet',
                model: 'WK-TC-BiFold',
                name: '对折桌配套桌布',
                nameEn: 'Bi-fold Table Tablecloths',
                nameZh: '对折桌配套桌布',
                ...
                specsEn: [
                    'Fits bi-fold table models: WK-Z122, WK-Z153, WK-Z183, WK-Z244',
                    '3D stretch & fitted cover styles',
                    'Custom printing and colors'
                ],
                keywords: [
                    'tablecloth', 'table cloth', 'bi-fold table', 'folding table', '对折桌', '桌布',
