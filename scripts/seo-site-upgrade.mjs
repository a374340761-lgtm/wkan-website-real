        ...
        <section class="wk-section wk-seo-hub-links" aria-label="B2B product landing pages">
            <div class="container">
                <div class="section-header">
                    ...
                    <p>Compare canopy tents, printed tents, beach flag hardware, portable displays, inflatable event structures and light boxes. Find product options and the details to include in your quotation request.</p>
                </div>
                <div class="wk-related-links">
